...
class __TwigTemplate_b0aa08bd09ba7834fd50e61c820232a5b217427b55f78e19e8e701b71663120d extends Twig_Template
{
    private $source;
...
{% block adminContent %}
    <div class=\"row\">
        ...
        <div class=\"col-4 text-right\">
            <a href=\"{{ path('admin_departamentos_new') }}\" class=\"btn btn-success\">
                <i class=\"fa fa-plus\"></i>
...
{% endblock %}
", "admin/departamentos/index.html.twig", "C:\\xampp\\htdocs\\SGA\\gerenciador-atendimento\\templates\\admin\\departamentos\\index.html.twig");
    }
}
