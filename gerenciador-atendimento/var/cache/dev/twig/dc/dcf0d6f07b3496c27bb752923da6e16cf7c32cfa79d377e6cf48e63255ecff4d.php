...
/* admin.html.twig */
class __TwigTemplate_285fe08f849caeddc7d2a71f5b3f6204963ebbdb1315559ac3506276ffab8568 extends Twig_Template
{
    private $source;
...
{% block body %}
    <div class=\"row\">
        <div class=\"col-md-2 col-lg-3\">
            <aside>
                <div class=\"list-group\">
                    <a href=\"{{ path('admin_index') }}\" class=\"list-group-item {% if tab == 'index' %}active bg-success{% endif %}\">
                        {{ 'admin.menu.system'|trans }}
                    </a>

                    <a href=\"{{ path('admin_unidades_index') }}\" class=\"list-group-item {% if tab == 'unidades' %}active bg-success{% endif %}\">
                        {{ 'admin.menu.unities'|trans }}
                    </a>

                    <a href=\"{{ path('admin_departamentos_index') }}\" class=\"list-group-item {% if tab == 'departamentos' %}active bg-success{% endif %}\">
                        {{ 'admin.menu.departments'|trans }}
                    </a>

                    <a href=\"{{ path('admin_servicos_index') }}\" class=\"list-group-item {% if tab == 'servicos' %}active bg-success{% endif %}\">
                        {{ 'admin.menu.services'|trans }}
                    </a>

                    <a href=\"{{ path('admin_perfis_index') }}\" class=\"list-group-item {% if tab == 'perfis' %}active bg-success{% endif %}\">
                        {{ 'admin.menu.roles'|trans }}
                    </a>

                    <a href=\"{{ path('admin_prioridades_index') }}\" class=\"list-group-item {% if tab == 'prioridades' %}active bg-success{% endif %}\">
                        {{ 'admin.menu.priorities'|trans }}
                    </a>

                    <a href=\"{{ path('admin_locais_index') }}\" class=\"list-group-item {% if tab == 'locais' %}active bg-success{% endif %}\">
                        {{ 'admin.menu.places'|trans }}
                    </a>

                    <a href=\"{{ path('admin_modulos_index') }}\" class=\"list-group-item {% if tab == 'modulos' %}active bg-success{% endif %}\">
                        {{ 'admin.menu.modules'|trans }}
                    </a>

                    <a href=\"{{ path('admin_api_index') }}\" class=\"list-group-item {% if tab == 'api' %}active bg-success{% endif %}\">
...
{% endblock %}
", "admin.html.twig", "C:\\xampp\\htdocs\\SGA\\gerenciador-atendimento\\templates\\admin.html.twig");
    }
}
