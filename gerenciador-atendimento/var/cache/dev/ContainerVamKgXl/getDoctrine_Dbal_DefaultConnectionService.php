...
$d->addEventListener(array(0 => 'postGenerateSchema'), 'App\\Extensions\\Doctrine\\SchemaViewIgnorer');
$d->addEventListener(array(0 => 'loadClassMetadata'), 'App\\Extensions\\Doctrine\\TablePrefix');
$d->addEventListener(array(0 => 'loadClassMetadata'), 'doctrine.orm.default_listeners.attach_entity_listeners');

return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array()))->createConnection(array('url' => $this->getEnv('resolve:DATABASE_URL'), 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driver' => 'pdo_mysql', 'driverOptions' => array(), 'defaultTableOptions' => array()), $a, $d, array());
