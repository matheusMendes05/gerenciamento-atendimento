...
// Returns the public 'App\Controller\Api\ServicosController' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Controller\\Api\\ServicosController.php';

return $this->services['App\Controller\Api\ServicosController'] = new \App\Controller\Api\ServicosController(($this->services['translator'] ?? $this->getTranslatorService()), $this->targetDirs[3]);
