...
// Returns the public 'App\Controller\Api\AtendimentosController' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Controller\\Api\\AtendimentosController.php';

return $this->services['App\Controller\Api\AtendimentosController'] = new \App\Controller\Api\AtendimentosController(($this->services['translator'] ?? $this->getTranslatorService()), $this->targetDirs[3]);
