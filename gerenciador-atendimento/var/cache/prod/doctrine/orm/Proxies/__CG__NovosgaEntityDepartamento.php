 ...
 */
class Departamento extends \Novosga\Entity\Departamento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Novosga\\Entity\\Departamento' . "\0" . 'nome', '' . "\0" . 'Novosga\\Entity\\Departamento' . "\0" . 'descricao', '' . "\0" . 'Novosga\\Entity\\Departamento' . "\0" . 'ativo', '' . "\0" . 'Novosga\\Entity\\Departamento' . "\0" . 'createdAt', '' . "\0" . 'Novosga\\Entity\\Departamento' . "\0" . 'updatedAt'];
        }
