 ...
 */
class Cliente extends \Novosga\Entity\Cliente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Novosga\\Entity\\Cliente' . "\0" . 'nome', '' . "\0" . 'Novosga\\Entity\\Cliente' . "\0" . 'documento', '' . "\0" . 'Novosga\\Entity\\Cliente' . "\0" . 'email', '' . "\0" . 'Novosga\\Entity\\Cliente' . "\0" . 'telefone'];
        }
