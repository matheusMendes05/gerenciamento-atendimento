 ...
 */
class OAuthClient extends \App\Entity\OAuthClient implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\OAuthClient' . "\0" . 'description', 'id', 'randomId', 'secret', 'redirectUris', 'allowedGrantTypes'];
        }
