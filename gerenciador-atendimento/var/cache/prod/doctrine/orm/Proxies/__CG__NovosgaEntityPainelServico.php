 ...
 */
class PainelServico extends \Novosga\Entity\PainelServico implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Novosga\\Entity\\PainelServico' . "\0" . 'painel', '' . "\0" . 'Novosga\\Entity\\PainelServico' . "\0" . 'servico', '' . "\0" . 'Novosga\\Entity\\PainelServico' . "\0" . 'unidade'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PainelServico $proxy) {
    ...
    public function getPainel()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPainel', []);

        return parent::getPainel();
    }
    ...
    public function setPainel($painel)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPainel', [$painel]);

        return parent::setPainel($painel);
    }
