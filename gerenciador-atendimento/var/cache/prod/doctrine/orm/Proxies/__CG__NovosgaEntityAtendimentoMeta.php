 ...
 */
class AtendimentoMeta extends \Novosga\Entity\AtendimentoMeta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AtendimentoMeta $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setAtendimento(\Novosga\Entity\Atendimento $atendimento)
    {
