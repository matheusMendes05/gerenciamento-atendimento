 ...
 */
class Atendimento extends \Novosga\Entity\Atendimento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Novosga\\Entity\\Atendimento' . "\0" . 'codificados', 'id', 'unidade', 'servico', 'usuario', 'usuarioTriagem', 'local', 'dataAgendamento', 'dataChegada', 'dataChamada', 'status', 'resolucao', 'cliente', 'senha', 'pai', 'observacao'];
        }
    ...
    public function hash()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hash', []);
    ...
    public function jsonSerialize($minimal = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'jsonSerialize', [$minimal]);
