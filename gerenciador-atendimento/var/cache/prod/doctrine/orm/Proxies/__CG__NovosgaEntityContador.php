 ...
 */
class Contador extends \Novosga\Entity\Contador implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Novosga\\Entity\\Contador' . "\0" . 'unidade', '' . "\0" . 'Novosga\\Entity\\Contador' . "\0" . 'servico', '' . "\0" . 'Novosga\\Entity\\Contador' . "\0" . 'numero'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Contador $proxy) {
