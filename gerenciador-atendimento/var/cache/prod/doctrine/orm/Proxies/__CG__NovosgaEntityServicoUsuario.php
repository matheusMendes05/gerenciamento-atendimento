 ...
 */
class ServicoUsuario extends \Novosga\Entity\ServicoUsuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Novosga\\Entity\\ServicoUsuario' . "\0" . 'servico', '' . "\0" . 'Novosga\\Entity\\ServicoUsuario' . "\0" . 'unidade', '' . "\0" . 'Novosga\\Entity\\ServicoUsuario' . "\0" . 'usuario', '' . "\0" . 'Novosga\\Entity\\ServicoUsuario' . "\0" . 'peso'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ServicoUsuario $proxy) {
