 ...
 */
class Servico extends \Novosga\Entity\Servico implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Novosga\\Entity\\Servico' . "\0" . 'nome', '' . "\0" . 'Novosga\\Entity\\Servico' . "\0" . 'descricao', '' . "\0" . 'Novosga\\Entity\\Servico' . "\0" . 'ativo', '' . "\0" . 'Novosga\\Entity\\Servico' . "\0" . 'peso', '' . "\0" . 'Novosga\\Entity\\Servico' . "\0" . 'mestre', '' . "\0" . 'Novosga\\Entity\\Servico' . "\0" . 'subServicos', '' . "\0" . 'Novosga\\Entity\\Servico' . "\0" . 'servicosUnidade', '' . "\0" . 'Novosga\\Entity\\Servico' . "\0" . 'createdAt', '' . "\0" . 'Novosga\\Entity\\Servico' . "\0" . 'updatedAt', '' . "\0" . 'Novosga\\Entity\\Servico' . "\0" . 'deletedAt'];
        }
     ...
     * {@inheritDoc}
     */
    public function setMestre(\Novosga\Entity\Servico $servico = NULL)
    {
