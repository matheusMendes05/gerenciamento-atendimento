 ...
 */
class AtendimentoHistoricoMeta extends \Novosga\Entity\AtendimentoHistoricoMeta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AtendimentoHistoricoMeta $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setAtendimento(\Novosga\Entity\AtendimentoHistorico $atendimento)
    {
