 ...
 */
class Unidade extends \Novosga\Entity\Unidade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Novosga\\Entity\\Unidade' . "\0" . 'nome', '' . "\0" . 'Novosga\\Entity\\Unidade' . "\0" . 'descricao', '' . "\0" . 'Novosga\\Entity\\Unidade' . "\0" . 'ativo', '' . "\0" . 'Novosga\\Entity\\Unidade' . "\0" . 'impressao', '' . "\0" . 'Novosga\\Entity\\Unidade' . "\0" . 'createdAt', '' . "\0" . 'Novosga\\Entity\\Unidade' . "\0" . 'updatedAt', '' . "\0" . 'Novosga\\Entity\\Unidade' . "\0" . 'deletedAt'];
        }
    ...
    public function getImpressao()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getImpressao', []);

        return parent::getImpressao();
    }
