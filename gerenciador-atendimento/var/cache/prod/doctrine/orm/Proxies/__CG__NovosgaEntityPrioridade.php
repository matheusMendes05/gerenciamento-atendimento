 ...
 */
class Prioridade extends \Novosga\Entity\Prioridade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Novosga\\Entity\\Prioridade' . "\0" . 'nome', '' . "\0" . 'Novosga\\Entity\\Prioridade' . "\0" . 'descricao', '' . "\0" . 'Novosga\\Entity\\Prioridade' . "\0" . 'peso', '' . "\0" . 'Novosga\\Entity\\Prioridade' . "\0" . 'ativo', '' . "\0" . 'Novosga\\Entity\\Prioridade' . "\0" . 'createdAt', '' . "\0" . 'Novosga\\Entity\\Prioridade' . "\0" . 'updatedAt', '' . "\0" . 'Novosga\\Entity\\Prioridade' . "\0" . 'deletedAt'];
        }
