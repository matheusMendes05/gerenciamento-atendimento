 ...
 */
class Perfil extends \Novosga\Entity\Perfil implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Novosga\\Entity\\Perfil' . "\0" . 'nome', '' . "\0" . 'Novosga\\Entity\\Perfil' . "\0" . 'descricao', '' . "\0" . 'Novosga\\Entity\\Perfil' . "\0" . 'modulos', '' . "\0" . 'Novosga\\Entity\\Perfil' . "\0" . 'createdAt', '' . "\0" . 'Novosga\\Entity\\Perfil' . "\0" . 'updatedAt'];
        }
